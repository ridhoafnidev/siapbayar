    ...
    <div class="card-body p-0">
      ...
      <div class="row">
        <div class="col-lg-5 d-none d-lg-block text-center">
          <img src="<?= base_url('assets/'); ?>logo/sistem.png" alt="logo-image" class="img-circle mt-5 mb-3">
          <h1 class="h4 text-gray-900 mb-1"><b>SISTEM</b>-<em>SPP</em></h1>
          <p class="mb-5"><em class="text-primary">Sistem Informasi Pembayaran SPP Online</em></p>
          <p class="lead text-gray-900">MDTA YAYASAN AL-FURQAN</p>
        </div>
        <div class="col-lg-7">
          <div class="p-4">
