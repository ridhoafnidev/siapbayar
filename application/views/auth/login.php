            ...
            <div class="col-lg">
              <div class="p-4">
                <div class="text-center">
                  <img src="<?= base_url('assets/'); ?>logo/sistem.png" alt="logo-image" class="img-circle">
                  <h1 class="h4 text-gray-900 mb-0"><b>SISTEM</b>-<em>SPP</em></h1>
                  ...
                  <!-- <p class="lead text-gray-900 mb-3">MDTA Yayasan Al-Furqan</p> -->
                  <hr>
