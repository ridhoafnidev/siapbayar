...
class Admin extends CI_Controller
{
    ...
    public function index()
    {
		...
		$data['transaksi'] = $this->Siswas_model->getAllCountTransaksi();
		$data['total_transaksi_bulanan'] = $this->Siswas_model->getMounthCountTransaksi();
		$data['bulan_sekarang'] = $this->Siswas_model->getCurrentMounth();
		$data['total_transaksi_tahunan'] = $this->Siswas_model->getYearsCountTransaksi();
		$data['total_siswa'] = $this->Siswas_model->getAllSiswa();
		$data['total_persen_pembayaran'] = $this->Siswas_model->getAllTransaksiInYearsPersen();
		$data['count_status_lunas'] = $this->Siswas_model->getTransaksiStatusLunas();
		$data['count_status_belum_lunas'] = $this->Siswas_model->getTransaksiStatusBelumLunas();
		$data['count_status_bayar_setengah'] = $this->Siswas_model->getTransaksiStatusBayarSetengah();
		$data['count_all_transaksi_in_years'] = $this->Siswas_model->getAllTransaksiInYears();
